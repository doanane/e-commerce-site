                            ...
                            <table class="table" height="190">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">
                                            <button class="delete-all btn btn-danger text-white">Clear</button>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="mb-4">
                                        ...
                                        <td class="total_price">
                                            <?php echo $product->pro_price * $product->pro_amount; ?></td>
                                        <td><button value="<?php echo $product->id; ?>"
                                                class="btn-update btn btn-warning text-white"><i class="fas fa-pen"></i>
                                            </button></td>
